...
public class TblProductoController implements Serializable {
    ...
    @EJB private com.unicauca.modelo.interfaces.ProductosFacadeLocal ejbFacade;
    ...
    public List<Producto> getItems() {
        if (items == null) {
            items = ejbFacade.buscarTodosProductos();
        }
        return items;
    }
        ...
        if (selected != null) {
            ...
            try {
                if (persistAction != PersistAction.DELETE) {
                    ejbFacade.crearProducto(selected);
                } else {
                    ejbFacade.eliminarProducto(selected);
                }
    ...
    public Producto getTblProducto(Long id) {
        return ejbFacade.buscarProducto(id);
    }

    public List<Producto> getItemsAvailableSelectMany() {
        return ejbFacade.buscarTodosProductos();
    }
